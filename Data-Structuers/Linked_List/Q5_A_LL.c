...
void frontBackSplitLinkedList(LinkedList *ll, LinkedList *resultFrontList, LinkedList *resultBackList)
{
	// 1. 리스트의 크기(ll->size)를 이용해 절반으로 나누기
	// ((ll->size)%2) -> 나머지가 있으면 +1
	//////////////////////////////////////////////////////////
	
	// int half = ((ll->size)/2)+((ll->size)%2);
	...
	// 	if(i<half){
	// 		// 0~half : resultFrontList
	// 		tmp = findNode(ll,i);
	// 		insertNode(resultFrontList,i,tmp->item);
	// 	}
	// 	else{
	// 		// half~ll->size : resultBackList
	// 		tmp = findNode(ll,i);
	// 		insertNode(resultBackList,j,tmp->item);
	// 		j++;
	// 	}
	// }
	///////////////////////////////////////////////////////////
	// findNode()로 인해 1의 시간 복잡도 O(n^2)
	// 2. findNode() 대신 순회 포인터 tmp를 이용해 불필요한 탐색 줄이기
	int half = ((ll->size)/2)+((ll->size)%2);
